...
export const MAX_PERSISTED_TAKES_PER_INSTRUMENT = 30
const SUPPORTED_INSTRUMENT_COUNT = 5
export const MAX_INSTRUMENT_TAKE_CACHE = SUPPORTED_INSTRUMENT_COUNT * MAX_PERSISTED_TAKES_PER_INSTRUMENT
