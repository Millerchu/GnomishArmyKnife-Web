...
.instrument-guitar.photo-background .fretted-stage {
  background-image:
...
.instrument-ukulele.photo-background .fretted-stage {
  background-image:
...
.instrument-pipa.photo-background .fretted-stage {
  background:
    ...
    url('/instrument-backgrounds/pipa-studio.png') center / cover;
}
...
.fretted-surface.photo-background .fretboard {
  background:
    repeating-linear-gradient(90deg, transparent 0 calc(12.5% - 2px), rgba(221, 208, 179, 0.76) calc(12.5% - 1px) 12.5%),
