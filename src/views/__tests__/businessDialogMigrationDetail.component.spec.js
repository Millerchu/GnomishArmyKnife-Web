...
const pageContracts = [
  ...
  },
  {
    ...
    dialogCount: 4,
    formIds: ['password-memo-edit-dialog-form', 'password-memo-history-form', 'password-memo-update-password-form', 'password-memo-verify-form'],
    panelClasses: ['password-memo-edit-dialog', 'password-memo-history-dialog', 'password-memo-update-password-dialog', 'password-memo-verify-dialog'],
    closeDisabledBindings: ['submitting', 'maintainingHistory', 'updatingPassword', 'detailLoading || verifyingPassword']
  },
  {
    name: '主页个人中心与退出确认',
