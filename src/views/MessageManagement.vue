<template>
  <main class="messages-page">
    ...
    <MacDialog v-model="previewOpen" :confirm-on-dirty="false" title="确认发送消息" subtitle="请核对内容和接收范围，发送后无法修改或撤回。" width="640px" :close-disabled="sending">
    ...
    <MacDialog :confirm-on-dirty="false" :model-value="Boolean(recipientMessage)" :title="`阅读情况 · ${recipientMessage?.title || ''}`" width="700px" @update:model-value="value => {if (!value) recipientMessage = null}">
